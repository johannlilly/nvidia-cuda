...
bool findDXDevice(char *dev_name)
{
    ...
    for (; !g_pCudaCapableAdapter; ++adapter)
    {
        ...
        printLastCudaError("cudaD3D10GetDevice failed"); //This prints and resets the cudaError to cudaSuccess
...
int main(int argc, char *argv[])
{
        ...
        SUCCEEDED(InitTextures()))
    {
        ...
        // get the list of interop devices
        {
            ...
            printLastCudaError("cudaD3D10GetDevices failed"); //This prints and resets the cudaError to cudaSuccess
